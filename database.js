    ...
    if(err) {
        ...
        db.run(`CREATE TABLE flowers (
            ...
            if (err) {
                ...
                db.run(insert, ['Blåsippa', 'Blåsippan är en fridlyst blomma vilket innebär att det är förbjudet att gräva eller plocka blomman samt använda den till försäljning. Blommar mellan april-maj. Vanligast i södra Sverige. Blomman växer mest i lövskogar. Är en ört och kan bli hundraårig.', 'blasippa.jpg', 1, 2, ' Varför är det förbjudet att plocka blåsippan?','Fridlyst', 'Giftig','Explosivt'])
                db.run(insert, ['Vitsippa', 'Vitsippan är en ört som blommar mellan april-maj. De vita blommorna kan skifta i rött när de är nyutslagna samt går mot sitt slut. Vitsippan finns i nästan hela landet och växer i skogs- och hagmarker.', 'vitsippa.jpg', 1, 3, 'Vilken färg blir vitsippan när den går mot sitt slut?', 'Röd', 'Blå', 'Grön'])
                ...
                db.run(insert, ['Påsklilja', 'Påskliljan är en flerårig lökväxt som tillhör familjen Amaryllisväxter. Blomman har en gul tub- eller trumpetliknande bikrona. Blommar april-maj.', 'pasklilja.jpg', 1, 5,'Vilken familj tillhör Påskliljan?' ,'Amaryllisväxter', 'Lökväxter','Sparrisväxter'])
                ...
                db.run(insert, ['Blåstjärna', 'Den ryska blåstjärnan tillhör familjen Sparrisväxter. Den blommar mellan april-maj och har blå violetta kronblad.', 'blastjarna.jpg', 1, 7,'Vilken växtfamilj tillhör den ryska blåstjärnan?','Sparrisväxter','Amaryllisväxter','Liljeväxter'])
                ...
                db.run(insert, ['Förgätmigej', 'Förgätmigej blommar från juni till augusti med ganska stora ljusblå eller vita blommor som sitter i ensidiga knippen. Arterna i släktet förgätmigejer (Myosotis) är alla ganska lika.', 'forgatmigej.jpg', 2, 2])
                ...
                db.run(insert, ['Blåklocka', 'Blåklocka är en ganska späd, flerårig ört, den växer ofta i glesa tuvor med veka uppstigande stjälkar och blir bara ett par decimeter hög. Blåklocka och/eller ängsklocka är Dalarnas landskapsblomma.', 'blaklocka.jpg', 2, 9])
