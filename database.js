    ...
    if(err) {
        ...
        db.run(`CREATE TABLE flowers (
            ...
            if (err) {
                ...
                db.run(insert, ['Blåsippa', 'Blåsippan är en fridlyst blomma vilket innebär att det är förbjudet att gräva eller plocka blomman samt använda den till försäljning. Blommar mellan april-maj. Vanligast i södra Sverige. Blomman växer mest i lövskogar. Är en ört och kan bli hundraårig.', 'blasippa.jpg', 1, 2, ' Varför är det förbjudet att gräva,plocka och/eller sälja blåsippan?', 'Giftig','Fridlyst','Explosivt'])
